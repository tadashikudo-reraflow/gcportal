            ...
            "mainEntity": [
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "デジタル庁が定めた「自治体情報システムの標準化・共通化」に準拠し、ガバメントクラウド（AWS・GCP・Azure・OCI・さくらのクラウド）上で稼働することが確認されたシステムパッケージです。住民基本台帳や税務など20業務が対象で、全国の自治体に移行が求められています（2026年度以降は運用フェーズへ移行）。"
                }
              },
              {
                "@type": "Question",
              ...
              {
                "@type": "Question",
                "name": "COKAS-R・RKKCS などのパッケージはどのベンダーですか？",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "COKAS-Rは株式会社両備システムズが提供するガバメントクラウド対応パッケージです。RKKCSは株式会社リコーが提供しており、九州・西日本の自治体への採用が多い製品です。いずれも業務別パッケージ一覧からご確認いただけます。"
                }
              },
              {
                "@type": "Question",
                "name": "パッケージ移行にかかるコストはどのくらいですか？",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "自治体規模やベンダー、業務数によって大きく異なりますが、中規模自治体（人口10万人程度）で数千万〜数億円規模の初期費用がかかるケースが報告されています。GCInsightのコスト試算ページでは自治体別のコスト動向を確認できます。"
                }
              },
              {
                "@type": "Question",
                "name": "デジタル庁の「適合確認」とパッケージ一覧の違いは何ですか？",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "デジタル庁の適合確認は、パッケージが標準仕様書に準拠していることを公式に認定したリストです。GCInsightのパッケージ一覧は適合確認情報に加え、採用自治体数・クラウド基盤・共同利用の有無など実運用データを組み合わせた独自のデータベースです。"
                }
              }
            ]
          })

...
export const metadata: Metadata = {
  title: "デジタル庁基準準拠｜ガバメントクラウド移行対象20業務の進捗率を業務別で公開【2026年4月】",
  description: "デジタル庁が定める標準化対象20業務ごとに、全国1,741自治体の移行進捗率を公開。完了率が最も低い業務ワースト5・特定移行団体の状況・業務別の遅延原因まで業務担当者向けに可視化。",
